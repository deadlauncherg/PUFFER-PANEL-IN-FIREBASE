...
# ========== lapiogaming Auto PufferPanel + Ngrok Script ==========
# No menu — just PufferPanel + Ngrok with authtoken prompt
# ================================================================
...
apt update && apt install -y wget curl tar bash gnupg ca-certificates sudo
